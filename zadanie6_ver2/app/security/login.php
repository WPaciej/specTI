...
$smarts->assign('app_url',$conf->app_url);
$smarts->assign('root_path',$conf->root_path);
$smarts->assign('page_title','Kalkulator kredytowy- WP');

$smarts->assign('form',$form);
$smarts->assign('messages',$messages);

// 5. Wywołanie szablonu
$smarts->display($conf->root_path.'\app\security\login_view.html');
} else { 
